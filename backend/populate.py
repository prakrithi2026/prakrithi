...
if not config_obj:
    ...
    # Seed initial hero section only if completely absent from SiteConfig (never overwrite admin changes)
    if 'hero' not in existing and full_data.get('hero'):
        existing['hero'] = full_data['hero']
